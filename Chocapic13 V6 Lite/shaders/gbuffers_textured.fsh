...
void main() {
	...
	albedo.rgb = ((sunlight*shading)*(2.15*0.63) + ambientNdotL.rgb*1.4*0.63)*pow(albedo.rgb,vec3(2.2));	//don't export to gamma 1/2.2 due to RGB11F format
}
